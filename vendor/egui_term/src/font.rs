...
impl TerminalFont {
    ...
    pub fn font_measure(&self, ctx: &Context) -> Size {
        ...
        // The backend and mouse protocol use integer logical cell dimensions.
        // Quantize once so painting, resizing and wheel scrolling agree.
        Size::new(width.ceil().max(1.0), (height * 1.2).ceil().max(1.0))
    }
}
