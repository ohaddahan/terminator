...
function M.get_alignments(base_start, base_end, input1_start, input1_end, input2_start, input2_end, input1_inner_diffs, input2_inner_diffs)
...
function M.compute_mapping_alignments(changes1, changes2)
